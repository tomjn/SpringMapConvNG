...
# prefer_static_libs()/unprefer_static_libs() are provided by the Recoil engine
# build system. Define self-contained fallbacks here so the static path works
# standalone in this project too.
if(NOT COMMAND prefer_static_libs)
  macro(prefer_static_libs)
    set(_DEVIL_SAVED_LIB_SUFFIXES ${CMAKE_FIND_LIBRARY_SUFFIXES})
    if(WIN32)
  ...
  macro(unprefer_static_libs)
    set(CMAKE_FIND_LIBRARY_SUFFIXES ${_DEVIL_SAVED_LIB_SUFFIXES})
  endmacro()
endif()
